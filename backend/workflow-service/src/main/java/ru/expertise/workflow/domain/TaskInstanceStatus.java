...
public enum TaskInstanceStatus {
    ...
    private static final Map<TaskInstanceStatus, Set<TaskInstanceStatus>> ALLOWED_TRANSITIONS = Map.of(
            CREATED, EnumSet.of(IN_PROGRESS, WAITING, OVERDUE, CANCELLED),
            IN_PROGRESS, EnumSet.of(WAITING, OVERDUE, COMPLETED, CANCELLED),
            WAITING, EnumSet.of(IN_PROGRESS, OVERDUE, CANCELLED),
            OVERDUE, EnumSet.of(IN_PROGRESS, COMPLETED, CANCELLED),
