-- Core workflow/routing schema (TZ-02-WORKFLOW): templates with routing rules and an SLA policy,
-- process instances, tasks with deadlines, the process journal and the transactional outbox.
