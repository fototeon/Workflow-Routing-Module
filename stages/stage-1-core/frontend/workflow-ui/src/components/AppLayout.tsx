...
import { getRoles } from '../auth/authConfig';
import { colors } from '../colors';

const DRAWER_WIDTH = 260;

// Every screen is offered to every signed-in user at this stage; the API is what enforces roles,
// answering 403 when a role may not perform an action.
const NAV_ITEMS = [
  { path: '/processes', label: 'Процессы', icon: DescriptionOutlinedIcon },
  { path: '/tasks', label: 'Задачи', icon: AssignmentTurnedInOutlinedIcon },
  { path: '/templates', label: 'Шаблоны процессов', icon: AccountTreeOutlinedIcon },
];
